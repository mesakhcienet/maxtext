...
def train_loop(config, config_inference, recorder, state=None):
  ...
  # TODO: need to find a good way for get_shaped_batch
  ...
  def generate_completions(
    ...
    with engine_lock:
      thread_example_batch = data_loader.load_next_batch()
  ...
  generate_completions(inference_engine, tokenizer_model, config_inference, config, data_buffer, data_buffer_lock, data_sharding, inference_engine_lock)
